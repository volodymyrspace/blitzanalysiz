...
stats.tier.type.perf <- get_stats_tank_perf(stats.tier.type)
rm(stats.tier)
...
The graph shows tier [`r tier.roman`](..) `r tank_type`s by _Relative WR_. That is the average of players' WR in a tank compared to their average WR at the tier (in all same tier tanks). Relative WR is a measure of the performance/strength of the tank. 
